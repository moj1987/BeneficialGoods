...
namespace BeneficialGoods.Model
{
    internal class ShopifyResponseDataModel
    {
        ...
        private IRestResponse GetResponse()
        {
            ...
            client.Timeout = -1;
            var request = new RestRequest($"admin/api/2021-04/orders.json?created_at_min={START_DATE}&created_at_max={END_DATE}&status=any&fields=line_items,created_at,financial_status", Method.GET, DataFormat.Json);
